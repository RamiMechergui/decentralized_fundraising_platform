...
const profileDetailsSchema = Yup.object().shape({
  ...
  localisation: Yup.string().required('Country is required'),
  paymentMethod: Yup.string().required('Payment Method is required'),
  // timeZone: Yup.string().required('Time zone is required'),
 rib: Yup.string().required('Currency is required'),
})
...
interface detailsProps {
  ...
  const ProfileDetails: React.FC <detailsProps> = ({ accessToken }) =>{
    ...
    const formik = useFormik<IProfileDetails>({
      ...
      onSubmit: async (values) => {
        setLoading(true);
        try {
          const response = await axios.post('http://backend.tokenopp.org/api/auth/modifyuser', values, {
            headers: {
          ...
          // The response.data will contain the updated user object from the backend
          const updatedUser = response.data;
           history.push('/crafted/account/settings');
      ...
      <div id='kt_account_profile_details' className='collapse show'>
        <form onSubmit={formik.handleSubmit} noValidate className='form'>
          <div className='card-body border-top p-9'>
            ...
            <div className='row mb-6'>
              <label className='col-lg-4 col-form-label fw-bold fs-6'>
                <span className='required'>Rib</span>
              </label>
              ...
              <div className='col-lg-8 fv-row'>
                <input
                  ...
                  className='form-control form-control-lg form-control-solid'
                  placeholder='Rib'
                  {...formik.getFieldProps('rib')}
                />
                {formik.touched.rib && formik.errors.rib && (
                  <div className='fv-plugins-message-container'>
                    <div className='fv-help-block'>{formik.errors.rib}</div>
                  </div>
                )}
              </div>
            </div>

  ...
  return (
    <Switch>
      <Route path='/crafted/pages/wizards/horizontal'>
        <PageTitle breadcrumbs={wizardsBreadCrumbs}> Deposit fundraising demand </PageTitle>
        <Horizontal />
      </Route>
      <Route path='/crafted/pages/wizards/vertical'>
        <PageTitle breadcrumbs={wizardsBreadCrumbs}> Investor application form </PageTitle>
        <Vertical />
      </Route>

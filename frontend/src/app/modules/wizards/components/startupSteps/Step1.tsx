...
const Step1: FC = () => {
  ...
  <div className='w-100'>
      ...
      <div className='fv-row mb-10'>
        <label className='form-label required'>State of funding</label>
        ...
        <div className='text-danger mt-2'>
          <ErrorMessage name='fundingState' />
        </div>
      </div>

      <div className='fv-row mb-10'>
        <label className='form-label required'> Activity Sector </label>
        ...
        <div className='text-danger mt-2'>
          <ErrorMessage name='activitySector' />
        </div>
      </div>
      ...
      <div className="mb-3">
        <label className="form-label required"> Upload pitch deck / video </label>
        <input
          type='file'
          name='pitch_video'
          className='form-control'
          onChange={(e) => formik.setFieldValue('pitch_video', e.currentTarget.files?.[0] )
          }/>
        <div className='text-danger mt-2'>
          <ErrorMessage name='pitch_video' />
        </div>
      </div>

      <div className="mb-3">
        <label className="form-label required"> Upload legal status </label>
        <input
          type='file'
          name='legal_status'
          className='form-control'
          onChange={(e) => formik.setFieldValue('legal_status', e.currentTarget.files?.[0] )
          }/>
        <div className='text-danger mt-2'>
      ...
      <div className="mb-3">
        <label className="form-label required"> Upload business registration number </label>
        <input
          type='file'
          name='business_registration_number'
          className='form-control'
          onChange={(e) => formik.setFieldValue('business_registration_number', e.currentTarget.files?.[0] )
          }/>
        <div className='text-danger mt-2'>
          <ErrorMessage name='business_registration_number' />
        </div>
      </div>
